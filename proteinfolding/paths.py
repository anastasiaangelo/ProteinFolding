...
PYROSETTA_ENERGY_DATA_ALL = ROOT_DIR / 'data/raw/pyrosetta_energy_all'
...
XY_QAOA_PLOTS_HYPERPARAMETER_ANALYSIS = XY_QAOA_PLOTS_DIR / 'hyperparameter_analysis'
...
OPTIMAL_PARAMETERS_FILE = 'optimal_parameters.csv'
...
EXACT_DATA_ENERGY_BITSTRING_FILE_ALL = EXACT_DATA_DIR / 'exact_energies_and_bitstrings_all.csv.gz'

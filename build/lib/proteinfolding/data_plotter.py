...
class DataPlotter:
    ...
    def plot_fraction_vs_shots(self, df_filtered, save_path=None):
        ...
        if save_path:
            ...
            plt.savefig(str(save_path) + f"/fraction_vs_shots_num_res_{df_filtered['num_res'].iloc[0]}_num_rot_{df_filtered['num_rot'].iloc[0]}.png")
    ...
    def plot_fraction_vs_p(self, df_filtered, save_path=None):
        ...
        if save_path:
            ...
            plt.savefig(str(save_path) + f"/fraction_vs_p_num_res_{df_filtered['num_res'].iloc[0]}_num_rot_{df_filtered['num_rot'].iloc[0]}.png")
    ...
    def plot_min_shots(self, df, save_path=None):
        ...
        for alpha, p in alpha_p_pairs:
            ...
            if save_path:
                ...
                plt.savefig(str(save_path) + f"/min_shots_vs_N_alpha_{alpha}_p_{p}.png")
    ...
    def plot_ground_state_probability_vs_N(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
            ...
            for alpha, p, shots in alpha_p_shots_pairs:
                ...
                if save_path:
                    ...
                    plt.savefig(str(save_path) + f"/ground_state_probability_vs_N_alpha_{alpha}_p_{p}_shots_{shots}.png")
    ...
    def plot_tail_probability_vs_N(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
            ...
            for alpha, p, shots in alpha_p_shots_pairs:
                ...
                if save_path:
                    ...
                    plt.savefig(str(save_path) + f"/tail_{tail}_probability_vs_N_alpha_{alpha}_p_{p}_shots_{shots}.png")
    ...
    def plot_ground_state_probability_vs_p(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for num_res, num_rot, alpha, shots in nres_nrot_alpha_shots_pairs:
            ...
            if save_path:
                ...
                plt.savefig(str(save_path) + f"/ground_state_probability_vs_p_num_res_{num_res}_num_rot_{num_rot}_alpha_{alpha}_shots_{shots}.png")
    ...
    def plot_ground_state_probability_vs_p_pooled_alpha(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for num_res, num_rot, shots in nres_nrot_shots_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"ground_state_probability_vs_p_num_res_{num_res}_num_rot_{num_rot}_shots_{shots}.png"))
    ...
    def plot_tail_probability_vs_alpha_pooled_p(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for num_res, num_rot, shots in nres_nrot_shots_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"tail_{tail}_probability_vs_alpha_num_res_{num_res}_num_rot_{num_rot}_shots_{shots}.png"))
    ...
    def plot_tail_probability_vs_alpha_pooled_num_res(self, df, xaxis='log', save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for num_rot, shots, p in nrot_shots_p_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"tail_{tail}_{xaxis}_probability_vs_alpha_p_{p}_num_rot_{num_rot}_shots_{shots}.png"))
    ...
    def plot_ground_state_probability_vs_alpha_pooled_num_res(self, df, xaxis='log', save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for num_rot, shots, p in nrot_shots_p_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"ground_state_{xaxis}_probability_vs_alpha_p_{p}_num_rot_{num_rot}_shots_{shots}.png"))
        ...
        for num_rot, shots, p in nrot_shots_p_pairs:
            ...
            if save_path:
                ...
                if not os.path.exists(save_path):
                    ...
                    os.makedirs(save_path)
                if approximation_ratio:
                    plt.savefig(os.path.join(save_path, f"{xaxis}_approximation_ratio_vs_alpha_p_{p}_num_rot_{num_rot}_shots_{shots}.png"))
                else:
                    plt.savefig(os.path.join(save_path, f"{xaxis}_cvar_vs_alpha_p_{p}_num_rot_{num_rot}_shots_{shots}.png"))
    ...
    def plot_ground_state_probability_vs_N_pooled_alpha(self, df, xaxis = 'log', save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for p, shots in p_shots_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"ground_state_{xaxis}_probability_vs_N_p_{p}_shots_{shots}.png"))
    ...
    def plot_tail_probability_vs_N_pooled_alpha(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for p, shots in p_shots_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"tail_{tail}_probability_vs_N_p_{p}_shots_{shots}.png"))
    ...
    def plot_tail_probability_vs_p_pooled_alpha(self, df, save_path=None, pos_bool=False, transverse_field_bool=False):
        ...
        for num_res, num_rot, shots in nres_nrot_shots_pairs:
            ...
            if save_path:
                ...
                plt.savefig(os.path.join(save_path, f"tail_probability_vs_p_num_res_{num_res}_num_rot_{num_rot}_shots_{shots}.png"))
